      ...
      <div className="relative w-full max-w-lg">
        ...
        <div className="bg-white/[0.02] border border-white/[0.07] rounded-3xl p-8">
          <form onSubmit={handleSubmit((d) => reg(d))} className="space-y-4">
            ...
            <div><label className="block text-xs font-semibold text-white/40 uppercase tracking-widest mb-2">Phone (Required)</label><input {...register("phone")} placeholder="+234 800 000 0000" className={inputCls} /></div>
