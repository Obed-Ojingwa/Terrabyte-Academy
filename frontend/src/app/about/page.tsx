...
export default function AboutPage() {
  return (
    <div className="page-light min-h-screen">
      ...
      {/* Mission */}
      <section className="py-16 px-6 md:px-12 border-y border-slate-200/60 bg-slate-50">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={item.label} className="page-surface rounded-2xl p-8">
              <div className="text-3xl mb-4">{item.icon}</div>
              <h3 className="font-bold text-slate-950 text-lg mb-3">{item.label}</h3>
      ...
      <section className="py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-brand-500 text-xs font-bold uppercase tracking-widest mb-3">What Drives Us</p>
            <h2 className="text-4xl font-black tracking-tight">Our Core Values</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {values.map((v) => (
              <div key={v.title} className="page-surface rounded-2xl p-7 hover:shadow-lg transition-all">
      ...
      {/* Team */}
      <section className="py-20 px-6 md:px-12 border-t border-slate-200/60 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-brand-500 text-xs font-bold uppercase tracking-widest mb-3">The People</p>
            <h2 className="text-4xl font-black tracking-tight">Meet the Team</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {team.map((member) => (
              <div key={member.name} className="page-surface rounded-2xl p-7 text-center hover:shadow-lg transition-all">
                ...
                <h3 className="font-bold text-slate-950 text-sm mb-1">{member.name}</h3>
                <p className="text-brand-500 text-xs font-semibold mb-3">{member.role}</p>
      ...
      {/* Stats */}
      <section className="py-20 px-6 md:px-12 border-t border-slate-200/60">
      ...
      {/* CTA */}
      <section className="py-16 px-6 md:px-12 text-center border-t border-slate-200/60">
        <h2 className="text-3xl font-black text-slate-950 mb-4">Ready to Join Our Community?</h2>
        <p className="text-slate-600/80 mb-8">Take the first step towards a future-proof tech career today.</p>
